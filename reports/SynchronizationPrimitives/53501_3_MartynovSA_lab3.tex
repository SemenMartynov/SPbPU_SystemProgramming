...
\bibitem{Ogins}Огинский А.А., Набатчиков А.М., Бурлак Е.А. Организация межпотокового взаимодействия с использованием объектов ядра операционной системы -- С. 52-56. Вестник компьютерных и информационных технологий. №8. Август 2012.

\bibitem{Schupak}Щупак Ю. А. Win32 API. Разработка приложений для Windows -- СПб.: Питер, 2008 -- 592 стр.

\bibitem{MSDN1}MSDN: Обзор асинхронной модели, основанной на событиях -- https://msdn.microsoft.com/ru-ru/wewwczdw.aspx

\bibitem{MSDN2}MSDN: Slim Reader/Writer (SRW) Locks -- https://msdn.microsoft.com/aa904937.aspx

\bibitem{Tanenbaum}Э. Таненбаум. Современные операционные системы -- СПб.:Питер, 2010. -- 1120 стр.
