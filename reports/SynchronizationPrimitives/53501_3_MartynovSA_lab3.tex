...
\lstinputlisting[language=C++, caption={Запуск кллиентских процессов (src/SynchronizationPrimitives/ProcessWriter/utils.cpp)}, firstline=20, lastline=76]
...
\lstinputlisting[language=C++, caption={Сервер-пистаель (src/SynchronizationPrimitives/ReaderWriterServer/main.cpp)}]
